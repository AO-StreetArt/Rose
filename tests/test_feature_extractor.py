...
class TestFeatureExtractor:
    ...
    def feature_extractor_base(self):
        return FeatureExtractor()


    def test_feature_extractor_init(self, feature_extractor_base):
        assert feature_extractor_base is not None


    def test_extract_features_mocked(self, feature_extractor_base):
        fe = feature_extractor_base
    ...
    def test_extract_features_on_square_image(self, feature_extractor_base):
    ...
    def test_extract_features_vit_mocked(self, feature_extractor_base):
        fe = feature_extractor_base
    ...
    def test_extract_features_dinov2_mocked(self, feature_extractor_base):
        fe = feature_extractor_base
        dummy_img = np.zeros((1, 224, 224, 3), dtype=np.uint8)
    ...
    def test_extract_features_vit_on_square_image(self, feature_extractor_base):
        img_path = os.path.join(os.path.dirname(__file__), 'squareTestImage.png')
        img_array = ImagePreprocessor.load_and_preprocess_image(img_path)
        fe = feature_extractor_base
    ...
    def test_extract_features_dinov2_on_square_image(self, feature_extractor_base):
        img_path = os.path.join(os.path.dirname(__file__), 'squareTestImage.png')
        img_array = ImagePreprocessor.load_and_preprocess_image(img_path)
        fe = feature_extractor_base
    ...
    def test_classify_image_vit_returns_label_and_score(self, feature_extractor_base):
        extractor = feature_extractor_base
    ...
    def test_classify_image_vit_on_square_image(self, feature_extractor_base):
        extractor = feature_extractor_base
        img_path = os.path.join(os.path.dirname(__file__), 'squareTestImage.png')
